...
urlpatterns = [ 
    # Examples:
	 ...
	 re_path(r'^class/(?P<semester>[0-9]{6})/(?P<edclass>EG[0-9]+)/$', views.ed_class_assignment_view, name='ed_class_assignment_view'),
	 re_path(r'^class/(?P<semester>[0-9]{6})/(?P<edclass>EG[0-9]+)/(?P<assignmentname>\w+)/$', views.ed_class_data_view, name='ed_class_data_view'),
