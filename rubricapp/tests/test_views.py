...
class ClassViewTest(TestCase):
    ...
    def add_two_classes_to_semester_add_two_students_to_class(self):
        ...
        rubric = Rubric.objects.create(name="bob")
        edclasssemester = Assignment.objects.create(semester=first_semester, edclass=edClass, assignmentname="Writing Assignment")#, keyrubric=rubric)
    ...
    def test_bob_cannot_see_jane_students(self):
        ...
        response = self.client.get('/assessment/201530/EG5111/writingassignment/')
    ...
    def test_student_page_returns_correct_template(self):
        self.add_two_classes_to_semester_add_two_students_to_class()
        response = self.client.get("/assessment/201530/EG500001/writingassignment/")
...
class AssignmentViewTest(TestCase):
    ...
    def add_two_classes_to_semester_add_two_students_to_class(self):
        ...
        #first_semester.classes.add(edClass1)
        rubric = Rubric.objects.create(name="bob")
        edclasssemester = Assignment.objects.create(semester=first_semester, edclass=edClass, assignmentname="Unit Plan")
        edclasssemestersecond = Assignment.objects.create(semester=first_semester, edclass=edClass, assignmentname="Writing Assignment")
        edclasssemester1 = Assignment.objects.create(semester=first_semester, edclass=edClass2)
        edclasssemester2 = Assignment.objects.create(semester=first_semester, edclass=edClass1)
    ...
    def test_assignment_page_resolves_to_assingment_function(self):
        self.add_two_classes_to_semester_add_two_students_to_class()
        found = resolve('/assessment/201530/EG500001/writingassignment/')
        self.assertEqual(found.func, assignment_page)
...
class StudentandRubricViewTest(TestCase):
    ...
    def test_rubric_page_not_viewable_by_dasterdaly_bob(self):
        ...
        response = self.client.get('/assessment/201530/EG5111/writingassignment/33333333/')
    ...
    def test_rubric_page_can_take_post_request(self):
        ...
        data ={"form-TOTAL_FORMS": "2",
               ...
               "form-0-id": "3",
               "form-1-id": "4"}
        response = self.client.post("/assessment/201530/EG500001/writingassignment/21743148/", data)
    ...
    def test_rubric_for_different_semester_doesnt_shows_up_in_correct_semester(self):
        ...
        response = self.client.get('/assessment/201610/EG500001/writingassignment/5555/')
